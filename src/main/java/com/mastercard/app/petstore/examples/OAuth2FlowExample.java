...
public class OAuth2FlowExample {
    ...
    public void oauth2UseCase() throws ApiException {
        // Create token
        Token token = oAuth2Service.createToken();

        // Use token to request resource
        TestResource testResource = oAuth2Service.getTestResource(token.getAccessToken());
